...
#  ____  _                   _  ____                        _                 _      
# | __ )(_) __ _ _ __   __ _| |/ ___|_ __ ___  ___ ___   __| | ___  _ __ ___ | | ___ 
# |  _ \| |/ _` | '_ \ / _` | | |  _| '__/ _ \/ __/ _ \ / _` |/ _ \| '_ ` _ \| |/ _ \
# | |_) | | (_| | | | | (_| | | |_| | | |  __/ (_| (_) | (_| | (_) | | | | | | |  __/
# |____/|_|\__, |_| |_|\__,_|_|\____|_|  \___|\___\___/ \__,_|\___/|_| |_| |_|_|\___|
#          |___/                                                                    
#
# [Binary Downloads]
#
    ...
    if [ $? -eq 0 ]; then
        ...
        case "$name" in
            ...
            bat)
                ...
                ;;
            delta)
                tar -xzf "$name.tar.gz" -C "$extract_dir" --strip-components=1 "delta-0.17.0-x86_64-unknown-linux-gnu/delta"
                ;;                
            *)
...
declare -A binaries=(
    ...
    ["bat"]="targz:https://github.com/sharkdp/bat/releases/download/v0.24.0/bat-v0.24.0-i686-unknown-linux-gnu.tar.gz:0.24.0"
    ["delta"]="targz:https://github.com/dandavison/delta/releases/download/0.17.0/delta-0.17.0-x86_64-unknown-linux-gnu.tar.gz:0.17.0"
...
#     local extract_dir=$3
# 
#     # echo "Debug - download_targz_binary - Name: $name"
#     # echo "Debug - download_targz_binary - URL: $url"
#     # echo "Debug - download_targz_binary - Extract Dir: $extract_dir"
# 
#     echo "Downloading and extracting $name from $url"
#     wget -q "$url" -O "$name.tar.gz"
#     if [ $? -eq 0 ]; then
...
#     local bin_dir=$3
# 
#     # echo "Debug - download_standalone_binary - Name: $name"
#     # echo "Debug - download_standalone_binary - URL: $url"
#     # echo "Debug - download_standalone_binary - Bin Dir: $bin_dir"
# 
#     echo "Downloading $name from $url"
#     wget -q "$url" -O "$bin_dir/$name"
#     if [ $? -eq 0 ]; then
...
# 
#     if ! [ -x "$bin_dir/$name" ]; then
#         # echo "Debug - Binary $name not found or not executable in $bin_dir"
#         echo "n/a"
#         return
#     fi
# 
...
# 
#     if [ -z "$version" ]; then
#         # echo "Debug - Failed to get version for $name"
#         version="unknown"
#     # else
#     #     echo "Debug - Detected version $version for $name"
#     fi
# 
#     echo "$version"
# }
...
# # Function to compare versions
# version_gt() {
#     # echo "Debug - Comparing versions: $1 and $2"
#     test "$(printf '%s\n' "$@" | sort -V | head -n 1)" != "$1"
#     # echo "Debug - Comparison result: $?"
# }
# 
# # List of binaries to manage
# declare -A binaries=(
...
#     echo "Processing $name..."
#     
#     # Split the string using ':' as delimiter, but only for the first two occurrences
#     value="${binaries[$name]}"
#     type="${value%%:*}"
#     rest="${value#*:}"
#     url="${rest%:*}"
...
#     # if [ "$current_version" = "n/a" ] || [ "$current_version" = "unknown" ]; then
#     #     echo "Debug - No current version or unknown version detected"
#     # elif version_gt "$version" "$current_version"; then
#     #     echo "Debug - New version is greater than current version"
#     # else
#     #     echo "Debug - Current version is up to date"
#     # fi
#     
#     if [ "$current_version" = "n/a" ] || [ "$current_version" = "unknown" ] || version_gt "$version" "$current_version"; then
#         if [ "$current_version" != "n/a" ]; then
